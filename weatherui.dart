...
import 'package:weather/apfile.dart' as util;
...
class _climateState extends State<climate> {
  ...
  Future _gotonextScreen1(BuildContext context) async {
    Map? result = await Navigator.of(context)
        .push(MaterialPageRoute<Map>(builder: (BuildContext context) {
      return climateChan();
    }));
...
class climateChan extends StatefulWidget {
  @override
  _climateChanState createState() => _climateChanState();
}

class _climateChanState extends State<climateChan> {
  var _cityFieldController = new TextEditingController();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
...
class defaultlocation extends StatefulWidget {
  @override
  _defaultlocationState createState() => _defaultlocationState();
}
